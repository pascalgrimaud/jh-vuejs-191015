        ...
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                ...
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('jhipsterApp.testRootBankAccount.guid')" for="bank-account-my-suffix-guid">Guid</label>
                        <input type="text" class="form-control" name="guid" id="bank-account-my-suffix-guid"
                            :class="{'valid': !$v.bankAccount.guid.$invalid, 'invalid': $v.bankAccount.guid.$invalid }" v-model="$v.bankAccount.guid.$model" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('jhipsterApp.testRootBankAccount.meanQueueDuration')" for="bank-account-my-suffix-meanQueueDuration">Mean Queue Duration</label>
                        <input type="number" class="form-control" name="meanQueueDuration" id="bank-account-my-suffix-meanQueueDuration"
                            :class="{'valid': !$v.bankAccount.meanQueueDuration.$invalid, 'invalid': $v.bankAccount.meanQueueDuration.$invalid }" v-model.number="$v.bankAccount.meanQueueDuration.$model" />
                    </div>
                    <div class="form-group">
