        ...
        <div class="table-responsive" v-if="bankAccounts && bankAccounts.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('jhipsterApp.testRootBankAccount.guid')">Guid</span></th>
                    ...
                    <th><span v-text="$t('jhipsterApp.testRootBankAccount.meanQueueDuration')">Mean Queue Duration</span></th>
                ...
                <tr v-for="bankAccount in bankAccounts"
                    ...
                    <td>{{bankAccount.lastOperationDate | formatDate}}</td>
