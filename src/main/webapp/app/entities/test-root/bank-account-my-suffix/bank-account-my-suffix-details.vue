        ...
        <div class="col-8">
            <div v-if="bankAccount">
                ...
                <dl class="row jh-entity-details">
                    ...
                    <dt>
                        <span v-text="$t('jhipsterApp.testRootBankAccount.guid')">Guid</span>
                    </dt>
                    <dd>
                        <span>{{bankAccount.guid}}</span>
                    </dd>
                    <dt>
                    ...
                    <dt>
                        <span v-text="$t('jhipsterApp.testRootBankAccount.meanQueueDuration')">Mean Queue Duration</span>
                    </dt>
                    <dd>
                        <span>{{bankAccount.meanQueueDuration}}</span>
                    </dd>
                    <dt>
                    ...
                    <dd>
                        <span>{{bankAccount.lastOperationDate | formatDate}}</span>
                    </dd>
                    <dt>
