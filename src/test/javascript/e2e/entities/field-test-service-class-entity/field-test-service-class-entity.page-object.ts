...
export default class FieldTestServiceClassEntityComponentsPage extends AlertPage {
...
export class FieldTestServiceClassEntityDeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.fieldTestServiceClassEntity.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-fieldTestServiceClassEntity'));
}
