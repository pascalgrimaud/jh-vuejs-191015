...
export default class EntityWithPaginationComponentsPage extends AlertPage {
...
export class EntityWithPaginationDeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.entityWithPagination.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-entityWithPagination'));
}
