...
export default class EntityWithServiceClassAndDTOComponentsPage extends AlertPage {
...
export class EntityWithServiceClassAndDTODeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.entityWithServiceClassAndDTO.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-entityWithServiceClassAndDTO'));
}
