...
export default class FieldTestPagerEntityComponentsPage extends AlertPage {
...
export class FieldTestPagerEntityDeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.fieldTestPagerEntity.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-fieldTestPagerEntity'));
}
