...
export default class EntityWithServiceImplAndPaginationComponentsPage extends AlertPage {
...
export class EntityWithServiceImplAndPaginationDeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.entityWithServiceImplAndPagination.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-entityWithServiceImplAndPagination'));
}
