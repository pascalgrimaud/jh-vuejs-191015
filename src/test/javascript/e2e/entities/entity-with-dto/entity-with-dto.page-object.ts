...
export default class EntityWithDTOComponentsPage extends AlertPage {
...
export class EntityWithDTODeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.entityWithDTO.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-entityWithDTO'));
}
