...
export default class EntityWithServiceImplComponentsPage extends AlertPage {
...
export class EntityWithServiceImplDeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.entityWithServiceImpl.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-entityWithServiceImpl'));
}
