...
export default class EntityWithServiceClassPaginationAndDTOComponentsPage extends AlertPage {
...
export class EntityWithServiceClassPaginationAndDTODeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.entityWithServiceClassPaginationAndDTO.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-entityWithServiceClassPaginationAndDTO'));
}
