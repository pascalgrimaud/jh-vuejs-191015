...
export default class FieldTestMapstructEntityComponentsPage extends AlertPage {
...
export class FieldTestMapstructEntityDeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.fieldTestMapstructEntity.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-fieldTestMapstructEntity'));
}
