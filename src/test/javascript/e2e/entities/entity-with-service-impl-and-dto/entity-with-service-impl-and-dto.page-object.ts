...
export default class EntityWithServiceImplAndDTOComponentsPage extends AlertPage {
...
export class EntityWithServiceImplAndDTODeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.entityWithServiceImplAndDTO.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-entityWithServiceImplAndDTO'));
}
