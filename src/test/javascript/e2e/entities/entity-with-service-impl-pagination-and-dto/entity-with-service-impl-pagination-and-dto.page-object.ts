...
export default class EntityWithServiceImplPaginationAndDTOComponentsPage extends AlertPage {
...
export class EntityWithServiceImplPaginationAndDTODeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.entityWithServiceImplPaginationAndDTO.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-entityWithServiceImplPaginationAndDTO'));
}
