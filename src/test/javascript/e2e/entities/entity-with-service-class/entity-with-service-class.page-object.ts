...
export default class EntityWithServiceClassComponentsPage extends AlertPage {
...
export class EntityWithServiceClassDeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.entityWithServiceClass.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-entityWithServiceClass'));
}
