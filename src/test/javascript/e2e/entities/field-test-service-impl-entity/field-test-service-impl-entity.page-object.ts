...
export default class FieldTestServiceImplEntityComponentsPage extends AlertPage {
...
export class FieldTestServiceImplEntityDeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.fieldTestServiceImplEntity.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-fieldTestServiceImplEntity'));
}
