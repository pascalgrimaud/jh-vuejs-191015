...
describe('BankAccount e2e test', () => {
  ...
  describe('Create flow', () => {
    ...
    it('should create and save BankAccounts', async () => {
      ...
      await updatePage.guidInput.sendKeys('64c99148-3908-465d-8c4a-e510e3ade974');
      expect(await updatePage.guidInput.getAttribute('value')).to.match(/64c99148-3908-465d-8c4a-e510e3ade974/);
      ...
      await updatePage.meanQueueDurationInput.sendKeys('PT12S');
      expect(await updatePage.meanQueueDurationInput.getAttribute('value')).to.contain('12');
    ...
    describe('Details, Update, Delete flow', () => {
      ...
      it('should load edit BankAccount page, fetch data and update', async () => {
        ...
        await updatePage.guidInput.clear();
        await updatePage.guidInput.sendKeys('64c99148-3908-465d-8c4a-e510e3ade978');
        expect(await updatePage.guidInput.getAttribute('value')).to.match(/64c99148-3908-465d-8c4a-e510e3ade978/);
        ...
        await updatePage.meanQueueDurationInput.clear();
        await updatePage.meanQueueDurationInput.sendKeys('PT14S');
        expect(await updatePage.meanQueueDurationInput.getAttribute('value')).to.contain('14');
