...
export default class FieldTestPaginationEntityComponentsPage extends AlertPage {
...
export class FieldTestPaginationEntityDeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.fieldTestPaginationEntity.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-fieldTestPaginationEntity'));
}
