...
export default class FieldTestEntityComponentsPage extends AlertPage {
...
export class FieldTestEntityDeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.fieldTestEntity.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-fieldTestEntity'));
}
