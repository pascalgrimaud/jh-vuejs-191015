...
export default class EntityWithServiceClassAndPaginationComponentsPage extends AlertPage {
...
export class EntityWithServiceClassAndPaginationDeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.entityWithServiceClassAndPagination.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-entityWithServiceClassAndPagination'));
}
