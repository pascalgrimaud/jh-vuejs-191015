...
export default class EntityWithPaginationAndDTOComponentsPage extends AlertPage {
...
export class EntityWithPaginationAndDTODeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.entityWithPaginationAndDTO.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-entityWithPaginationAndDTO'));
}
