...
export default class FieldTestInfiniteScrollEntityComponentsPage extends AlertPage {
...
export class FieldTestInfiniteScrollEntityDeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhipsterApp.fieldTestInfiniteScrollEntity.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-fieldTestInfiniteScrollEntity'));
}
